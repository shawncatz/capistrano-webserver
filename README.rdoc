...
[webserver_configfile]	*default: config/webserver/webserver.conf*
...
[webserver_restart]	*default: true*
			Should the webserver be restarted after configuration is updated.

== Module variables

[webserver_configdir]	This is defined by the capistrano_webserver modules. For apache, this would generally point to
